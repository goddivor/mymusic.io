...
const fr = {
  ...
  sectionData: 'DONNÉES',
  exportBackup: 'Sauvegarder maintenant',
  exportBackupSub: 'Vers ton dossier de sauvegarde',
  importBackup: 'Restaurer une sauvegarde',
  importBackupSub: 'Depuis un fichier',
  backupFolder: 'Dossier de sauvegarde',
  backupFolderOn: 'Configuré',
  backupFolderOff: 'Non défini',
  backupFolderSet: 'Dossier de sauvegarde défini',
  autoBackup: 'Sauvegarde automatique',
  enabled: 'Activée',
  disabled: 'Désactivée',
  restorePrompt: 'Une sauvegarde a été trouvée. Restaurer ta bibliothèque ?',
  restorePromptTitle: 'Restaurer la bibliothèque',
  restore: 'Restaurer',
  later: 'Plus tard',
  backupExported: 'Sauvegarde exportée',
  backupImported: 'Sauvegarde restaurée',
  backupFailed: 'Échec de la sauvegarde',
  noBackupFound: 'Aucune sauvegarde trouvée',
  grantPermission: 'Autoriser l\'accès aux fichiers audio',
  ...
  outputPhoneSub: 'Le son sort du téléphone',
  webPlayer: 'Lecteur web',
  outputWebSub: 'Le son sort du navigateur',
  starting: 'Démarrage…',
  connectHint: 'Ouvre l\'adresse affichée sur ton ordinateur : la page reste synchronisée avec ce téléphone.',
  connectPinHint: 'Code PIN : {pin}. Ouvre l\'adresse ci-dessus sur ton ordinateur pour piloter la lecture.',
  connect: 'Connexion',
  ...
  maxParallelDownloads: 'Téléchargements simultanés',
  maxCollectionDownloads: 'Limite par playlist',
  unlimited: 'Illimité',
  select: 'Sélectionner',
  selectAll: 'Tout',
  selectedCount: '{n} sélectionné(s)',
  deleteSelectedQ: 'Supprimer la sélection ?',
  deleteSelectedMsg: '{n} titre(s) téléchargé(s) seront supprimés du téléphone.',
  removeSelectedMsg: '{n} titre(s) seront retirés de « {collection} ».',
  addTracksTitle: 'Ajouter {n} titres à…',
  deletePlaylistChoiceMsg: 'Que faire de « {name} » ?',
  deletePlaylistOnly: 'Supprimer la playlist seulement',
  deletePlaylistWithTracks: 'Supprimer aussi les titres téléchargés',
  deletePlaylistWithTracksQ: 'Supprimer playlist et titres ?',
  deletePlaylistWithTracksMsg:
    '« {name} » et ses titres téléchargés seront définitivement supprimés du téléphone.',
...
const en: Record<keyof typeof fr, string> = {
  ...
  githubRepoSub: 'github.com/goddivor/mymusic.io',
  sectionData: 'DATA',
  exportBackup: 'Back up now',
  exportBackupSub: 'To your backup folder',
  importBackup: 'Restore a backup',
  importBackupSub: 'From a file',
  backupFolder: 'Backup folder',
  backupFolderOn: 'Configured',
  backupFolderOff: 'Not set',
  backupFolderSet: 'Backup folder set',
  autoBackup: 'Automatic backup',
  enabled: 'On',
  disabled: 'Off',
  restorePrompt: 'A backup was found. Restore your library?',
  restorePromptTitle: 'Restore library',
  restore: 'Restore',
  later: 'Later',
  ...
  grantPermission: 'Allow access to audio files',
  ...
  outputPhoneSub: 'Audio plays on the phone',
  webPlayer: 'Web player',
  outputWebSub: 'Audio plays in the browser',
  starting: 'Starting…',
  connectHint: 'Open the address shown on your computer: the page stays in sync with this phone.',
  connectPinHint: 'PIN: {pin}. Open the address above on your computer to control playback.',
  connect: 'Connect',
  ...
  maxParallelDownloads: 'Simultaneous downloads',
  maxCollectionDownloads: 'Playlist download limit',
  unlimited: 'Unlimited',
  select: 'Select',
  selectAll: 'All',
  selectedCount: '{n} selected',
  deleteSelectedQ: 'Delete selection?',
  deleteSelectedMsg: '{n} downloaded track(s) will be removed from this phone.',
  removeSelectedMsg: '{n} track(s) will be removed from “{collection}”.',
  addTracksTitle: 'Add {n} tracks to…',
  deletePlaylistChoiceMsg: 'What should happen to “{name}”?',
  deletePlaylistOnly: 'Delete playlist only',
  deletePlaylistWithTracks: 'Also delete downloaded tracks',
  deletePlaylistWithTracksQ: 'Delete playlist and tracks?',
  deletePlaylistWithTracksMsg:
    '“{name}” and its downloaded tracks will be permanently removed from this phone.',
