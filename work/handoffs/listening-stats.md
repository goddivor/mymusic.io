...
- 💻 **Reference**: the existing implementation, `src/screens/ListeningStatsScreen.tsx` — match its conventions
- 📐 **Spec**: `docs/BRIEF.md`
...
- **Implementation**: `src/screens/ListeningStatsScreen.tsx`
- **Container**: `App.tsx`
...
- playCounts from the library store
...
- play counts already tracked in SQLite; drawer entry shows 'coming soon'
