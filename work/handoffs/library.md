...
- 🎨 **Artifact**: [`library.html`](../mockups/library.html) — the visual reference to match
- 💻 **Reference**: the existing implementation, `src/screens/LibraryScreen.tsx` — match its conventions
- 📐 **Spec**: `docs/BRIEF.md`
...
- **Entry**: `tab`
- **Implementation**: `src/screens/LibraryScreen.tsx`
- **Container**: `App.tsx`
...
- all/albums/playlists/youtube/local
- folder view
- empty

## 5. Watch-points

- playlist folders live here

## 6. Definition of Done

- [ ] Matches the artifact `library.html`
